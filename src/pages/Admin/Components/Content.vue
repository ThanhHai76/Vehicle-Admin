                                              ...
                                              <div class="nk-tb-col tb-col-sm">
                                                  <div class="user-card">
                                                      <div class="user-avatar user-avatar-sm bg-warning">
                                                          <img src="@/assets/auth-css/images/avatar/b-sm.jpg" alt="">
                                                      </div>
                                                      <div class="user-name">
                              ...
                              <div class="card card-bordered card-full">
                                  ...
                                  <ul class="nk-activity">
                                      <li class="nk-activity-item">
                                          <div class="nk-activity-media user-avatar bg-success"><img src="@/assets/auth-css/images/avatar/c-sm.jpg" alt=""></div>
                                      ...
                                      <li class="nk-activity-item">
                                          <div class="nk-activity-media user-avatar bg-purple"><img src="@/assets/auth-css/images/avatar/d-sm.jpg" alt=""></div>
                                          <div class="nk-activity-data">
